class CoffeeMachine:
    ...
    def report(self):
        """Prints a report of the remaining materials in the coffee machine"""
...
def order_drink():
    ...
    user_input = input("What kind of drink do you wish to order? ")
    ...
    if drink:
        money_machine.make_payment(float(drink.cost))
